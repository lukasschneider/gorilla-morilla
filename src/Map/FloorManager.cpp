...
Floor FloorManager::createFloor(SDL_Renderer *render, SDL_FRect *camera) {
    ...
    RoomManager rm;
    Room *room = rm.create_room(0, render, RoomManager::MapType::TP_TOP_LEFT_BOTTOM_RIGHT, camera);
    ...
    /* Room 0 */
    floor.addEdge(room, room3, 0);
    floor.addEdge(room, room1, 1);
    floor.addEdge(room, room4, 2);
    floor.addEdge(room, room5, 3);

    /* Room 1 */
    floor.addEdge(room1, room2, 0);
    floor.addEdge(room1, room1, 1);
    floor.addEdge(room1, room1, 2);
    floor.addEdge(room1, room, 3);

    /* Room 2 */
    floor.addEdge(room2, room2, 0);
    floor.addEdge(room2, room2, 1);
    floor.addEdge(room2, room1, 2);
    floor.addEdge(room2, room3, 3);

    /* Room 3 */
    floor.addEdge(room3, room3, 0);
    floor.addEdge(room3, room2, 1);
    floor.addEdge(room3, room, 2);
    floor.addEdge(room3, room3, 3);

    /* Room 4 */
    floor.addEdge(room4, room, 0);
    floor.addEdge(room4, room4, 1);
    floor.addEdge(room4, room6, 2);
    floor.addEdge(room4, room4, 3);

    /* Room 5 */
    floor.addEdge(room5, room5, 0);
    floor.addEdge(room5, room, 1);
    floor.addEdge(room5, room5, 2);
    floor.addEdge(room5, room5, 3);

    /* Room 6 */
    floor.addEdge(room6, room4, 0);
